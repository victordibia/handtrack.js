...
},{"core-js/library/fn/array/from":"node_modules/core-js/library/fn/array/from.js"}],"static/js/dataset.js":[function(require,module,exports) {
"use strict";
...
$(function () {
  ...
  numberArray = (0, _from.default)(Array(200).keys());
  console.log(numberArray);

  function loadSampleDataset() {
    datasetList.forEach(each => {
      $imagebox = $("<div id='" + each + "' class='sampleimagebox iblock'>" + "<img class='sampleimg eachimagebox expandable' src= 'static/assets/images/dataset/images/" + each + "' data-title= '" + each + "'data-id='" + each + "'  />" + // "<div class='imghovermenubar'> <div class='imagehovermenu'>save</div></div>" + 
      "</div>");
  ...
  function loadGenDataset() {
    $(".gen64box").fadeOut(function () {
      ...
      numberArray.forEach(each => {
        // each = index
        $imagebox = $("<div id='" + each + "' class='sampleimagebox iblock'>" + "<img class='sampleimg eachimagebox expandable' src= 'static/assets/images/gens128/" + each + ".jpg' data-title= '" + each + "'data-id='" + each + "'  />" + // "<div class='imghovermenubar'> <div class='imagehovermenu'>save</div></div>" + 
        "</div>");
...
},{"babel-runtime/core-js/array/from":"node_modules/babel-runtime/core-js/array/from.js"}]},{},["static/js/dataset.js"], null)
//# sourceMappingURL=/dataset.3413555a.map