...
for(let r=0;r<e.length;r++)a.beginPath(),a.rect(...e[r].bbox),a.lineWidth=1,a.strokeStyle="red",a.fillStyle="green",a.stroke(),a.fillText(e[r].score.toFixed(3)+" "+e[r].class,e[r].bbox[0],10<e[r].bbox[1]?e[r].bbox[1]-5:10)}}exports.load=load,exports.ObjectDetection=ObjectDetection,Object.defineProperty(exports,"__esModule",{value:!0})});
