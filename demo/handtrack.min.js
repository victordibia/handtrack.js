...
const a=new ObjectDetection(t);return await a.load(),a}function startVideo(e){return e.height=e.height||400,e.width=e.width||500,new Promise(function(t){navigator.mediaDevices.getUserMedia({audio:!1,video:{facingMode:"user",width:600,height:500}}).then(a=>{window.localStream=a,e.srcObject=a,e.onloadedmetadata=()=>{t(!0)}}).catch(function(){t(!1)})})}function stopVideo(){window.localStream.getTracks().forEach(e=>{e.stop()})}function getValidResolution(e,t,a){const n=t*e-1;return n-n%a+1}function getInputTensorDimensions(e){return e instanceof Tensor?[e.shape[0],e.shape[1]]:[e.height,e.width]}function calculateMaxScores(e,t,a){const n=[],r=[];for(let o=0;o<t;o++){let t=Number.MIN_VALUE,s=-1;for(let n=0;n<a;n++)e[o*a+n]>t&&(t=e[o*a+n],s=n);n[o]=t,r[o]=s}// console.log([maxes, classes])
